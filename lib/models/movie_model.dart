...
List<MovieModel> movieList = [
  ...
  MovieModel(
    ...
    casts: ["Chris Hemsworth", "Natalie Portman", "Christian Bale"],
    rating: 7.0,
    synopsis:
        "Thor must team up with the mighty Valkyrie, the fierce warrior Lady Sif, and the cunning trickster Loki to save the universe from the powerful and ruthless villain Gorr the God Butcher.",
    imgUrl: "assets/images/loventhunder.jpg",
    movieUrl: "https://en.wikipedia.org/wiki/Thor:_Love_and_Thunder", 
    price: 22000)
  ];